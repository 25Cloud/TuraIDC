...
`demo_style` is a TuraIDC addon example based on the ZJMF `public/plugins/addons/demo_style` package shape.

It keeps TuraIDC's current plugin runtime contract:
