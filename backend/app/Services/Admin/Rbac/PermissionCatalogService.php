...
class PermissionCatalogService
{
    ...
    private function detectGroup(string $permission): string
    {
        return match ($permission) {
            ...
            AdminPermissions::TICKET_LIST, AdminPermissions::TICKET_REPLY, AdminPermissions::TICKET_MANAGE, AdminPermissions::TICKET_DELIVERY_MANAGE, AdminPermissions::TICKET_PRE_REPLY_MANAGE => 'support_ticket',
    ...
    private function actionLabel(string $permission): string
    {
        ...
        return [
            ...
            'reply' => '回复',
            'conversations' => '对话列表',
            'delivery_manage' => '传递配置',
            'pre_reply_manage' => '预回复设置',
            'settings' => '配置',
            'delete' => '删除',
            'report' => '报表',
            'withdraw' => '提现',
    ...
    private function label(string $permission): string
    {
        return [
            ...
            AdminPermissions::TICKET_DELIVERY_MANAGE => '配置工单传递设置',
            AdminPermissions::TICKET_PRE_REPLY_MANAGE => '配置工单预回复设置',
