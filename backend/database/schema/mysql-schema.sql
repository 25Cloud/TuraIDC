...
) ENGINE=InnoDB AUTO_INCREMENT=1036453 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1014122 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2795 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='账单明细表，记录账单内每个收费项目和快照信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3012 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='账单主表，所有购买、续费、充值、扣款和退款流程以账单为财务入口';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=166216 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=380 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品表，记录可售卖产品的分类、定价、库存、上游绑定和开通策略';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=302 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='服务实例表，记录用户已购买产品的生命周期、计费、上游和续费状态';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ticket_delivery_rules` (
  ...
  `provider_key` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_scope_mode` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'selected',
  `upstream_department_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `enabled` tinyint(1) NOT NULL DEFAULT '1',
  `sync_admin_replies` tinyint(1) NOT NULL DEFAULT '0',
  `auto_reply_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `auto_reply_content` text COLLATE utf8mb4_unicode_ci,
  `mask_keywords` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ticket_delivery_rule_scope_unique` (`supplier_id`,`department`,`provider_key`,`product_scope_mode`),
...
CREATE TABLE `ticket_replies` (
  ...
  `sender_type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ticket_reply_deliveries` (
  ...
  `content_prefix` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `idempotency_key` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `remote_event_id` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ticket_upstream_bindings` (
  ...
  `supplier_id` bigint unsigned DEFAULT NULL,
  `upstream_department_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `upstream_service_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `upstream_ticket_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `attempts` int unsigned NOT NULL DEFAULT '0',
  `last_error` text COLLATE utf8mb4_unicode_ci,
  `last_attempt_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `ticket_upstream_delivery_logs` (
  ...
  `direction` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'outbound',
  ...
  `provider_key` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `supplier_id` bigint unsigned DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=988049 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (192,'2026_08_20_160000_create_ticket_upstream_delivery_logs',95);
