...
本文件约束所有在 TuraIDC 仓库内的协作、修改、验证与提交行为；工程细节从各领域文档按需进入，本文件只保留跨领域的强制规则。
...
- [文档治理策略](DOCUMENTATION_POLICY.md)：文档放置、结构与生命周期。
- [后端工程规范](../BACKEND.md)、[前端项目规范](../FRONTEND.md)、[数据库结构说明](../DATABASE.md)：各领域工程约束。
- [参考资料索引](../references/README.md)：稳定操作资料入口。
