...
本文是系统架构的当前真源，面向新入项开发者、代理和后端/前端/运维协作者，说明仓库结构、后端与前端架构、本地与生产运行方式以及数据库与文档资产口径。细节以运行代码、测试和实库为准。
...
- [后端工程规范](BACKEND.md) / [前端项目规范](FRONTEND.md)：两侧的工程约束细节。
- [参考资料索引](references/README.md)：部署、调度、测试与运维操作入口。
- [设计文档索引](designs/index.md)：架构与方案级决策记录。
