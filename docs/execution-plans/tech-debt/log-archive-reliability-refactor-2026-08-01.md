...
- 设计真源：[日志与归档协同重构方案](../../designs/backend/log-and-archive-coordination-refactor.md)
- 产品规格：[日志检索与归档协同](../../product-specs/active/log-search-archive-coordination-2026-08-01.md)
- 依据：[日志归档与 MySQL 日志维护](../../references/database/log-archive-and-mysql-maintenance.md)、[现行归档命令](../../../backend/app/Console/Commands/DatabaseArchiveLogsCommand.php)
- 当前状态：仅完成只读审计和方案编制；未执行归档、未删除历史文件、未变更生产配置。
- 2026-08-12 转入技术债：不在当前迭代排期，保留决策依据；重新评估条件以[产品规格](../../product-specs/active/log-search-archive-coordination-2026-08-01.md)与[设计文档](../../designs/backend/log-and-archive-coordination-refactor.md)为准。
