...
| [代理折扣设计](backend/2026-08-20-agent-discount-design.md)                     | active       | 代理折扣体系：与会员等级独立、矩阵折扣、成本价保护与优惠券兼容。 |
| [开放 API（Open API v2）设计文档](backend/2026-08-24-open-api-design.md)        | active       | API Key 认证、业务域×读写 scope、实例间对接与转售链路。          |
