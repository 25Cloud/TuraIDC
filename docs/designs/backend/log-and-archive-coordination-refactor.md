...
本文是日志写入、检索、保留、归档与删除的一体化技术设计。方案已基于代码完成静态审查，尚未变更任何数据、生产调度或保留策略。

- 对应规格：[日志检索与归档协同](../../product-specs/active/log-search-archive-coordination-2026-08-01.md)
- 对应计划：[日志归档系统可靠性重构方案](../../execution-plans/tech-debt/log-archive-reliability-refactor-2026-08-01.md)
